...
const creditCardCategoryId = '67a04d0f004e4bbd529ec054'
const bankAccountCategoryId = '67a04d0f004e4bbd529ec055'
	...
	await prisma.campaign.createMany({
		data: [
			// #region:Vpbstepup
			{
				...
				subLink:
					'https://cards.fimi.tech/?click_id={{orderId}}&partner=Fimi_affiliate&affiliate_code={{code}}&info={{prefillInfo}}',
				images: [
					{
				...
				specs: [
					...
					},
					{
						...
						description: [
							'Không có nợ xấu, nợ chú ý trong vòng 12 tháng gần nhất'
						]
					},
					{
						title: 'Thu nhập',
				...
				commissionPolicy: {
					...
					commissions: 350000,
					comDescription: 'thẻ phát hành có phát sinh giao dịch thành công.',
			...
			// #region:Hdbvjp
			{
				...
				commissionPolicy: {
					...
					description:
						'Có thể tiến hành lên lệnh rút tiền khi trạng thái đơn trên báo cáo là "Ghi nhận hoa hồng"',
					commissions: 150000,
					comDescription: 'thẻ phát hành thành công.',
					note: 'Chưa trừ 10% thuế TNCN.'
				},
				recognitionRules: {
					summary:
			...
			// #region:Vibtra
			{
				...
				commissionPolicy: {
					...
					description:
						'Có thể tiến hành lên lệnh rút tiền khi trạng thái đơn trên báo cáo là "Ghi nhận hoa hồng"',
					commissions: 500000,
					comDescription: 'thẻ phát hành thành công hạn mức > 0 đồng.',
					note: 'Chưa trừ 10% thuế TNCN.'
				},
				recognitionRules: {
					summary:
			...
			// #region:Vpbankneo
			{
				...
				commissionPolicy: {
					...
					commissions: 50000,
					comDescription:
						'khi khách hàng có phát sinh giao dịch thanh toán hóa đơn tối thiểu 20,000đ (*)',
					subCom: [
						{
							add: 40000,
							description:
								'khi thỏa điều kiện (*) và khách hàng duy trì số dư casa từ 500,000đ, tháng ghi nhận tối đa M1.'
						},
						{
							add: 70000,
							description:
								'khi thỏa điều kiện (*) KH duy trì số dư casa từ 800,000đ, tháng ghi nhận tối đa M1.'
						}
					],
					note: 'Chưa trừ 10% thuế TNCN.'
				},
